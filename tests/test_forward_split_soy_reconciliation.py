...
Shape taken from a real 2022 case whose EoY reconciliation fails, reduced to
the arithmetic and re-expressed with synthetic quantities. The point of the
...
is unambiguous. Given SoY 4, one pre-split buy, a 20-for-1 split and a sell of

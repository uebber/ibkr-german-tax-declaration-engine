...
Which losses may be set against which gains, and which pot each belongs to. The rules determine
the split across Zeilen 19-25 of Anlage KAP, and they changed materially between VZ 2024 and
VZ 2025.
...
### [GT-ESTG20-030] Satz 1 -- No cross-income offsetting
...
This creates a separate loss pool (Aktienverlusttopf), reported on Zeile 23 apart from other
losses. Carryforward applies under Satz 2 analogously.
...
### [GT-ESTG20-034] Satz 5 (current) -- Bescheinigung requirement
...
### [GT-ESTG20-035] Satz 5 a.F. -- Derivative loss cap (ABOLISHED)
...
### [GT-ESTG20-036] Satz 6 a.F. -- Worthless securities cap (ABOLISHED)
...
### [GT-ESTG20-037] The repeal and its application rule (Tier 1, verbatim)
...
**What "alle offenen Faelle" means:** the legislature did not set a first year of application --
it ordered the old provisions *not to be applied* to any case still open. A return being prepared
now for VZ 2021, 2022, 2023 or 2024 is such a case. There is therefore **no assessment year for
which the EUR 20 000 cap should be applied.**
...
them. The cap is dead in every year; the separate lines are not.
...
## Year-specific form structure

### [GT-FORM-010] VZ <= 2024 -- separate Termingeschaefte lines
...
### [GT-FORM-012] Verification of the line numbers, per year (Validation Protocol item 4)
...
**VZ 2020 and earlier have a different form structure.** On the 2020 form, Zeilen 21

...
| Shares received as a benefit for placing capital | EStG 22 Nr. 3; 8 Abs. 2 S. 1; 11 Abs. 1 S. 1 | none located addressing a benefit conditional on a vesting period | Anlage SO (Leistungen) for the receipt -- **Zeilen not held in this library**; Anlage KAP Z19-23 for the later disposal | tax-law/estg-22-nr3-leistungen.md [GT-ESTG20-063], [GT-ESTG20-064], [GT-ESTG20-065] |
...
| Acquisition-incidental costs (commission, transaction tax) | EStG / HGB | 20 Abs. 4 S. 1 (subtracted as Anschaffungskosten) + 255 Abs. 1 S. 2 HGB (Nebenkosten are part of them) | (raises cost basis -> KAP Z19/20/22/26) | estg-20-kapitalvermoegen.md [GT-ESTG20-066] |

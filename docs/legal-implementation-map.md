...
unchanged. Currency (foreign-cash) ledgers remain pooled per person — that is a separate concern
([GT-FX-008]); see the `GT-ESTG20-061` row and `reference/`.
...
Umbuchung between accounts is inert — a later change.

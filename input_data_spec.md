...
| CSV Header         | Model Field Name (Pydantic) | Model Data Type   | Description                                                                 | Notes (Optionality, Example, Parsing Detail)                                                                                                                                           |
|--------------------|-----------------------------|-------------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `ClientAccountID`  | `client_account_id`         | `Optional[str]`   | The client's account identifier.                                            | Required in the CSV (see `POSITIONS_COLUMNS`). Parsed via its own alias; the separate `account_id` field (alias `AccountId`) does not map to this header and stays unset. One row per account is emitted per instrument, and rows for the same instrument are summed. Example: "U1234567" |
